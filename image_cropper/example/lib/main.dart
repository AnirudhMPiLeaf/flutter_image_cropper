    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: const [
          ...
          BottomNavigationBarItem(icon: Icon(Icons.abc), label: '4'),
          BottomNavigationBarItem(icon: Icon(Icons.abc), label: '5'),
          BottomNavigationBarItem(icon: Icon(Icons.abc), label: '6'),
        ],
        currentIndex: index,
      ),
      body: Column(
